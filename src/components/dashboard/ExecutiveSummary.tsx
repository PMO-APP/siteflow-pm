  ...
  return (
    <div className="card overflow-hidden">
      <div className="card-head">
        ...
        <button onClick={copySummary} className="btn-ghost btn-sm btn">
          <Copy size={13} />
          Copy
        </button>
      </div>
      ...
      <div className="p-5">
        <div className="rounded-xl border border-white/[0.06] bg-white/[0.03] p-4 text-sm text-[#bfb9ae] leading-relaxed whitespace-pre-line">
          {summary}
        </div>

        <div className="mt-4 flex items-center gap-2 text-xs text-[#6e7d8c]">
          <FileText size={14} />
