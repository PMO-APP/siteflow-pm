...
export default function PMOWeeklyReportPage() {
  ...
  return (
    <div className="pmx-command-page min-h-screen -m-4 space-y-6 bg-[#f6f5f1] p-4 text-[#18212b] sm:-m-6 sm:p-6">
      ...
      <section className="no-print rounded-[2rem] border border-[#ffd1c5] bg-gradient-to-br from-[#111820] via-[#162230] to-[#0f151c] p-6 sm:p-8">
      ...
      <div id="executive-report-print" className="card p-6 print-dark">
        ...
        <div className="border-t border-white/10 mt-6 pt-4 text-[10px] text-[#74818d] print-dark">
...
function ReportBlock({
  ...
  return (
    <div className="mt-5">
      ...
      <div className="rounded-xl border border-white/10 bg-white p-4 text-sm text-[#536170] whitespace-pre-wrap min-h-[60px] print-dark">
        {value || '—'}
      </div>
    </div>
  )
