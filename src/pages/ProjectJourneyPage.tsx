...
export default function ProjectJourneyPage() {
  ...
  const [newItem, setNewItem] = useState({ stage: STAGES[0][0] as string, title: '', description: '', owner: '', planned_date: '', evidence_required: false })
  ...
  async function addJourneyItem() {
    ...
    if (inserted.error) {
      ...
      setNewItem({ stage: STAGES[0][0], title: '', description: '', owner: '', planned_date: '', evidence_required: false })
