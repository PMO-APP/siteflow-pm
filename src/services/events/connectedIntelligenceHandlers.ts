...
const HEALTH_TRIGGERS: ProjectEventType[] = [
  ...
  'SNAG_CREATED',
  'SNAG_CLOSED',
  'HSE_OBSERVATION_CREATED',
  'HSE_OBSERVATION_UPDATED',
  'HSE_OBSERVATION_CLOSED',
  'HSE_INCIDENT_CREATED',
  'HSE_INCIDENT_UPDATED',
  'HSE_INCIDENT_CLOSED',
  'HANDOVER_BLOCKED',
  'HANDOVER_APPROVED',
...
function eventTitle(event: ProjectEvent) {
  const labels: Partial<Record<ProjectEventType, string>> = {
    ...
    HSE_OBSERVATION_CREATED: 'HSE observation created',
    HSE_OBSERVATION_CLOSED: 'HSE observation closed',
    HSE_INCIDENT_CREATED: 'HSE incident recorded',
    HSE_INCIDENT_CLOSED: 'HSE incident closed',
